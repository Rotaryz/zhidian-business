          ...
          <div class="img-container">
            <div class="container-item">
              <div class="img-box" v-for="(item, index) in [1, 2, 3, 4, 5]" :key="index">
                ...
                <base-wx-input class="img-bc image-file" @change="_fileDetail($event)" accept="image/*" v-if="serviceDetail.goods_images.length == index" :multiple="5" :debugModel="true"></base-wx-input>
              </div>
            </div>
            <div class="container-item">
