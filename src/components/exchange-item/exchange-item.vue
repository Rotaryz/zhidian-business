  ...
  <div class="service-item">
    <div class="item-content">
      <div class="item-left" :style="{backgroundImage: 'url(' + item.image_url + ')',backgroundPosition: 'center',backgroundRepeat: 'no-repeat',backgroundSize: 'cover'}">
        <div class="left-cover" :class="tabIdx == 1 ? '' : 'hide'">已过期</div>
      </div>
      <div class="item-right">
        <div class="right-title">{{item.title}}</div>
        <div class="right-down">
          <div class="down-left">
            <p class="down-txt">库存：{{item.stock}}</p>
            <p class="down-txt second"><span class="first-txt">领取：{{item.sale_count}}</span></p>
          </div>
      ...
      <div class="editor-box" :class="showEdit ? '' : 'hide'">
        <div class="editor-container">
          <div class="editor-content">
            ...
            <div class="editor-item" v-if="false" @click.stop="itemDown(item)">
              <div class="item-icon down"></div>
              <div class="item-txt">下架</div>
            </div>
            <div class="editor-item" @click.stop="itemDelete(item)">
